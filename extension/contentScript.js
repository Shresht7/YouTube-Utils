(() => {
  ...
  var registered;
  var youTubeNavEvent = "yt-navigate-start";
  ...
  function contentScript() {
    ...
    const loopToggleBtn = new DOMElement("div").withID("yt-utils-loopControl").withHTML(setLoopHTML()).withClasses([".ytp-button"]).withStyles({
      display: "flex",
